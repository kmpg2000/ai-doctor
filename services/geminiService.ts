...
export const chatWithDoctor = async (
  ...
  const systemInstruction = `
    ...
    【重要：対応範囲の厳格な制限】
    - あなたは「医療・健康・病気・身体の不調」に関する相談のみを受け付けます。
    - **上記以外の話題（天気、スポーツ、政治、プログラミング、一般的な雑談、旅行、エンタメなど）には一切回答しないでください。**
    - 医療に関係ない質問が来た場合は、理由を述べず「申し訳ありませんが、私は医療AIのため、健康や病気に関するご相談以外にはお答えできません。」と定型的に断ってください。
